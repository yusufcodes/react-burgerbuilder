...
class ContactData extends Component {
    ...
    orderHandler = (event) => {
        ...
        // Data transformation: Extracting only the data we need from the original object
    ...
    checkValidity(value, rules) {
        ...
        // Checking to ensure field is NOT empty
        if (rules.required) {
    ...
    render() {
        ...
        // Creating an array of JavaScript Objects, so we can iterate over it
